 ...
 *
 * <p>
 * All Agents must have three things: a constructor that initializes the agent
 * with a game and whether the agent is the red player, a name, and the ability
 * to move.
 * </p>
 */
public abstract class Agent {
	 ...
	 * super(game, iAmRed); ...before constructing any other initial information.
	 * </p>
	 *
	...
	/**
	 * Make a move in the game. At the beginning of this method, the myGame object
	 * will be ready for a move. After this method has run, exactly one piece should
	 * be added to the game board with no other changes made.
	 *
	 * <p>
